---
title: "Epithelial integrity controls competency of hiPSCs into Primitive Streak by regulatoring TGF-b receptor accessibility"
subtitle: "Bioinformatics project | IBDM | Rosana Dono & Diane Rattier"
author:
...
We plot the normalized count values for the top 20 differentially expressed genes (by padj values).

```{r toppadj, echo=FALSE, results = "asis", message=FALSE, warning = FALSE}
<<toppadj>>
```
