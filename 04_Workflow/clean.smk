...
rule trimmomatic:
  ...
  output:
    sample_trimmed=expand( "05_Output/02_trimmomatic_qual2/{samples}_{ext}.trimmed.fastq", samples=SAMPLES, ext=["1","2"]),
    sample_untrimmed=expand( "05_Output/02_trimmomatic_qual2/{samples}_{ext}un.trimmed.fastq", samples=SAMPLES, ext=["1","2"])
...
rule fastqc_trimmed:
  ...
  input:
    expand( "05_Output/02_trimmomatic_qual2/{samples}_{ext}.trimmed.fastq", samples=SAMPLES, ext=["1","2"])
