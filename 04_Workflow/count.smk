...
#tsh_cpm = config["filtering"]["tsh_cpm"]
...
rule cpm_filtering:
  output:
    count_df = "05_Output/07_cpm/count.txt",
    cpm = "05_Output/07_cpm/cpm_filtered.txt",
    output_filter_count = "05_Output/07_cpm/count_filtered.txt"
